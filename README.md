# nodeschool_aurelia
Code for the NodeSchool Łódź workshop on Aurelia and possibly progressive web apps, if time permits. Based on the Aurelia Skeleton App, original read me below.
